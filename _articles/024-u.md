...
<div class="article-navigation">
  {% assign prev_article = site.articles | where: "number", 23 | first %}
  {% assign next_article = site.articles | where: "number", 25 | first %}
